...
class OnlineSquareUsers
{
    ...
    /**
     * OnlineSquareUsers constructor.
     */
    function __construct()
    {
        TableManager::getInstance()->add('OnlineSquareUsers', [
        ...
        $this->table = TableManager::getInstance()->get('OnlineSquareUsers');
    }
     ...
     * @return mixed
     */
    function set($fd, $username, $avatar, $channel = 1)
    {
